...
{ 
  ...
  if (fileTypeId == 3)
  {
    ...
    global.dbConnectionsPool.query('SELECT image_id, manually_validated, query FROM `image-ranker-collector-data2`.user_data_native_queries;', 
  ...
  else 
  {
    ...
    try 
    {
      // ======================================================
      // ======================================================
      resultFilename = global.imageRanker.ExportDataFile(kwScDataType, fileTypeId, outputFilepath, native);
      // ======================================================
      // ======================================================
    } 
    catch(err)
